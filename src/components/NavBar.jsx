...
const NavBar = () => {
  ...
  return (
    <div className="flex md:absolute flex-col md:flex-row md:min-h-screen">
      {/* Sidebar for Desktop */}
      <div className="hidden md:flex flex-col bg-[#31a831] w-64 text-white min-h-screen p-6">
      ...
      <div className="flex md:hidden justify-between items-center bg-[#31a831] text-white p-5">
      ...
      <div
        className={`${
          isOpen ? "block" : "hidden"
        } bg-[#31a831] text-white transition-all md:hidden`}
      >
